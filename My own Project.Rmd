...
dtLong <- dtLong %>%
  ...
  mutate(
    ...
    negEmoPP_cw = negEmo_mean-mean(negEmo_mean, na.rm = T),
    posEmoPP_cw = posEmo_mean-mean(posEmo_mean, na.rm = T),
    disempPP_cw = negEmo_mean-mean(negEmo_mean, na.rm = T),
    PFSPP_cw =  fail01_mean-mean(fail01_mean, na.rm = T),
    ...
    disempCtry_cw = negEmoCountry_mean-mean(negEmoCountry_mean, na.rm = T),
    PFSCtry_cw =  fail01Country_mean-mean(fail01Country_mean, na.rm = T),
    happyCtry_cw = happyCountry_mean-mean(happyCountry_mean, na.rm = T),
    WB = happy,
...
```{r}
ana_lv12 <- lme4::lmer(WB ~ negEmo_c + posEmo_c + PFS_c + disemp_c + negEmoPP_c + posEmoPP_c + PFSPP_c + disempPP_c +
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
```{r}
ana_lv12_int <- lme4::lmer(WB ~ negEmo_c*disemp_c + posEmo_c*disemp_c + PFS_c*disemp_c + negEmoPP_c*disempPP_c + posEmoPP_c*disempPP_c + PFSPP_c*disempPP_c +
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
If at all we are underestimating effects on level 2 due to potential small cluster size (Schunck, 2016)
```{r}
ana_lv123 <- lme4::lmer(WB ~ negEmo_c + posEmo_c + PFS_c + disemp_c + negEmoPP_c + posEmoPP_c + PFSPP_c + disempPP_c + 
...
```{r}
ana_lv123_int <- lme4::lmer(WB ~ negEmo_c*disemp_c + posEmo_c*disemp_c + PFS_c*disemp_c + negEmoPP_c*disempPP_c + posEmoPP_c*disempPP_c + PFSPP_c*disempPP_c +
...
```{r}
 stargazer::stargazer(ana_lv0, ana_lv1, ana_lv1_int, ana_lv12, ana_lv12_int, ana_lv123, ana_lv123_int,
                ...
                digits=2,
                digits.extra = 2,
                order = c(1, 14, 18, 2, 15, 19, 3, 16, 20, 13, 17, 21, 4, 7, 11, 5, 8, 12, 6, 9, 13),
...
```{r}
ana_lv12_intCross <- lme4::lmer(c19ProSo03 ~ negEmo_c*disemp_c + posEmo_c*disemp_c + PFS_c*disemp_c + 
                             negEmoPP_c*disempPP_c + posEmoPP_c*disempPP_c + PFSPP_c*disempPP_c +  
...
summary(ana_lv12_intCross)
performance::icc(ana_lv12_intCross)
...
# more importantly calculate autocorelation for residuals
saveRes <- residuals(ana_lv12_intCross)
plot(saveRes)
autocorrelation <- acf(saveRes, lag.max=50, plot=T, na.action = na.pass)
autocorrelation; rm(saveRes, autocorrelation)

# interactiosn
# sjPlot::plot_model(ana_lv12_intCross, type = "int", mdrt.values = "meansd")
# 
# interactions::sim_slopes(ana_lv12_intCross, pred = "posEmo_c", modx = "disemp_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
# interactions::sim_slopes(ana_lv12_intCross, pred = "negEmo_c", modx = "disemp_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
# interactions::sim_slopes(ana_lv12_intCross, pred = "PFS_c", modx = "disemp_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
# interactions::sim_slopes(ana_lv12_intCross, pred = "posEmoPP_c", modx = "disempPP_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
# interactions::sim_slopes(ana_lv12_intCross, pred = "negEmoPP_c", modx = "disempPP_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
# interactions::sim_slopes(ana_lv12_intCross, pred = "PFSPP_c", modx = "disempPP_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
```
...
```{r}
 stargazer::stargazer(ana_lv0, ana_lv1, ana_lv1_int, ana_lv12, ana_lv12_int, ana_lv123, ana_lv123_int,
                ...
                digits=2,
                digits.extra = 2,
                order = c(1, 14, 18, 2, 15, 19, 3, 16, 20, 13, 17, 21, 4, 7, 10, 5, 8, 11, 6, 9, 12),
                title='WellBeing Analyses',
                column.labels = c("randomInt", "level1", "level1+int", "level1-2", "level1-2+int", "level1-3", "level1-3+int"),
...
#                 column.labels = c("randomInt", "level1", "level1+int", "level1-2", "level1-2+int", "level1-3", "level1-3+int"),
#                 dep.var.labels = c("ProSocial"),
#                 out="output/tables/oldProSocial_noWellBeing.html")
...
#### cross-level interactions (1,2)
```{r}
ana_lv12_intCross <- lme4::lmer(c19ProSo03 ~ negEmo_c*disemp_c + posEmo_c*disemp_c + PFS_c*disemp_c + WB_c*disemp_c +
                             negEmoPP_c*disempPP_c + posEmoPP_c*disempPP_c + PFSPP_c*disempPP_c +  WBPP_c*disempPP_c + 
...
ana_lv12_intCross <- lme4::lmer(c19ProSo03 ~ negEmo_c + posEmo_c + PFS_c + WB_c + disemp_c +
                             negEmoPP_c + posEmoPP_c + PFSPP_c +  WBPP_c + disempPP_c +
                             negEmo_c*disempPP_c + posEmo_c*disempPP_c + PFS_c*disempPP_c +  WB_c*disempPP_c + 
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
# interactions::sim_slopes(ana_lv12_intCross, pred = "posEmoPP_c", modx = "disempPP_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
# interactions::sim_slopes(ana_lv12_intCross, pred = "negEmoPP_c", modx = "disempPP_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
interactions::sim_slopes(ana_lv12_intCross, pred = "WB_c", modx = "disempPP_c", johnson_neyman = TRUE, jnplot = TRUE, confint = TRUE)
```
...
```{r}
 stargazer::stargazer(ana_lv0, ana_lv1, ana_lv1_int, ana_lv12, ana_lv12_int, ana_lv123, ana_lv123_int,
                ...
                digits=2,
                digits.extra = 2,
                order = c(1, 18, 23, 2, 19, 24, 3, 20, 25, 4, 21, 26, 5, 22, 27, 6, 10, 14, 7, 11, 15, 8, 12, 16),
                title='WellBeing Analyses',
                column.labels = c("randomInt", "level1", "level1+int", "level1-2", "level1-2+int", "level1-3", "level1-3+int"),
                dep.var.labels = c("ProSocial"),
...
stargazer::stargazer(ana_lv0, ana_lv1, ana_lv1_int, ana_lv12, ana_lv12_int, ana_lv123, ana_lv123_int,
                ...
                column.labels = c("randomInt", "level1", "level1+int", "level1-2", "level1-2+int", "level1-3", "level1-3+int"),
                dep.var.labels = c("ProSocial"),
                out="output/tables/oldProSocial.html")
...
If at all we are underestimating effects on level 2 due to potential small cluster size (Schunck, 2016)
```{r}
ana_lv12 <- lme4::lmer(WB ~ negEmo_cw + posEmo_cw + PFS_cw + disemp_cw + negEmoPP_cw + posEmoPP_cw + PFSPP_cw + disempPP_cw +
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
```{r}
ana_lv12_int <- lme4::lmer(WB ~ negEmo_cw*disemp_cw + posEmo_cw*disemp_cw + PFS_cw*disemp_cw + negEmoPP_cw*disempPP_cw + posEmoPP_cw*disempPP_cw + PFSPP_cw*disempPP_cw +
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
If at all we are underestimating effects on level 2 due to potential small cluster size (Schunck, 2016)
```{r}
ana_lv123 <- lme4::lmer(WB ~ negEmo_cw + posEmo_cw + PFS_cw + disemp_cw + negEmoPP_cw + posEmoPP_cw + PFSPP_cw + disempPP_cw + 
...
```{r}
ana_lv123_int <- lme4::lmer(WB ~ negEmo_cw*disemp_cw + posEmo_cw*disemp_cw + PFS_cw*disemp_cw + negEmoPP_cw*disempPP_cw + posEmoPP_cw*disempPP_cw + PFSPP_cw*disempPP_cw +
...
First question: Do we need multilevel modeling? Run intercept only model! If amount of variance on level 2/3 is significant multilevel modeling is handy (but taking into account nestedness almost always is).
```{r}
lm.0 <- lm(WB ~ 1, # each person can have its own intercept relative to the country
                  data = dtLong)
ana.0 <- lme4::lmer(WB ~ 1 + 
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
anova(ana.0, lm.0)
summary(ana.0)
performance::icc(ana.0)

# more importantly calculate autocorelation for residuals
saveRes <- residuals(ana.0)
plot(saveRes)
autocorrelation <- acf(saveRes, lag.max=50, plot=T, na.action = na.pass)
autocorrelation; rm(saveRes, autocorrelation)
```
...
Second step: Add all level 1 predictors
```{r}
ana.1 <- lme4::lmer(WB ~ negEmo_cw + posEmo_cw + PFS_cw + disemp_cw +
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)

summary(ana.1)
performance::icc(ana.1)
...
Third step: Add all level 1 predictors and their interactions
```{r}
ana.1 <- lme4::lmer(WB ~ negEmo_cw*disemp_cw + posEmo_cw*disemp_cw + PFS_cw*disemp_cw +
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
First question: Do we need multilevel modeling? Run intercept only model! If amount of variance on level 2/3 is significant multilevel modeling is handy (but taking into account nestedness almost always is).
```{r}
lm.0 <- lm(c19ProSo03 ~ 1, # each person can have its own intercept relative to the country
                  data = dtLong)
ana.0 <- lme4::lmer(c19ProSo03 ~ 1 + 
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
Second step: Add all level 1 predictors
```{r}
ana.1 <- lme4::lmer(c19ProSo03 ~ negEmo_cw + posEmo_cw + PFS_cw + disemp_cw + WB_cw +
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
...
Third step: Add all level 1 predictors and their interactions
```{r}
ana.1 <- lmerTest::lmer(c19ProSo03 ~ negEmo_cw*disemp_cw + posEmo_cw*disemp_cw + PFS_cw*disemp_cw + WB_cw +
                    (1|coded_country) + # each country can have its own intercept
                    (1|coded_country:PPID), # each person can have its own intercept relative to the country
                  data = dtLong)
