...
#            c19RCA02 = scale(c19RCA02, center = T, scale = F),
#            c19RCA03 = scale(c19RCA03, center = T, scale = F),
#            para01 = scale(para01, center = T, scale = F),
#            para02 = scale(para02, center = T, scale = F),
#            para03 = scale(para03, center = T, scale = F)
#            )
```
...
<!--             para =~ para01 + para02 + para03 -->
<!--             # Regression -->
<!--             consp ~ a1*disemp + para -->
<!--             perBeh ~ b1*consp + c1*disemp + para -->
<!--             level:2 -->
<!--             # Latent -->
<!--             disemp =~ fail01 + fail02 + fail03 -->
<!--             consp =~ consp01 + consp02 + consp03 -->
...
<!--             para =~ para01 + para02 + para03 -->
<!--             # Regression -->
<!--             consp ~ d1*disemp + para -->
<!--             perBeh ~ e1*consp + f1*disemp + para -->
<!--             # Indirect and total effects within -->
<!--             ab:=a1*b1 -->
<!--             totalwith:=ab+c1 -->
<!--             # Indirect and total effects between -->
...
<!--             # Regression -->
<!--             consp ~ a1*disemp + para -->
<!--             proSo ~ b1*consp + c1*disemp + para -->
<!--             RCA ~ b2*consp + c2*disemp + para -->
<!--             level:2 -->
<!--             # Latent -->
<!--             disemp =~ fail01 + fail02 + fail03 -->
<!--             consp =~ consp01 + consp02 + consp03 -->
...
<!--             # Regression -->
<!--             consp ~ d1*disemp + para -->
<!--             proSo ~ e1*consp + f1*disemp + para -->
<!--             RCA ~ e2*consp + f2*disemp + para -->
<!--             # Indirect and total effects within -->
<!--             abProSo:=a1*b1 -->
<!--             abRCA:=a1*b2 -->
<!--             totalwithProSo:=abProSo+c1 -->
